...
function TableIndex() {
 ...
 const data = [
  ...
  },
  {
    ...
    "Google Cloud Skills Boost Profile URL": "https://www.cloudskillsboost.google/public_profiles/a77e6853-eefa-4263-8007-4d5ff5880e24",
    "Profile URL Status": "All Good",
    "Prompt Design in Vertex AI Completion": 0,
    "Develop GenAI Apps with Gemini and Streamlit Completion": 0,
    "Gen AI Arcade Game Completion": 0,
  ...
  },
  {
    ...
    "Google Cloud Skills Boost Profile URL": "https://www.cloudskillsboost.google/public_profiles/2077c194-b1c9-438b-ab57-7e7bdbade9c7",
    "Profile URL Status": "All Good",
    "Prompt Design in Vertex AI Completion": 0,
    "Develop GenAI Apps with Gemini and Streamlit Completion": 0,
    "Gen AI Arcade Game Completion": 0,
  ...
  },
  {
    ...
    "Google Cloud Skills Boost Profile URL": "https://www.cloudskillsboost.google/public_profiles/20933f59-d793-453b-8555-42ae66f66150",
    "Profile URL Status": "All Good",
    "Prompt Design in Vertex AI Completion": 0,
    "Develop GenAI Apps with Gemini and Streamlit Completion": 0,
    "Gen AI Arcade Game Completion": 0,
  ...
  },
  {
    ...
    "Google Cloud Skills Boost Profile URL": "https://www.cloudskillsboost.google/public_profiles/860af910-d27c-48b1-8696-b0e29ffade5b",
    "Profile URL Status": "All Good",
    "Prompt Design in Vertex AI Completion": 0,
    "Develop GenAI Apps with Gemini and Streamlit Completion": 0,
    "Gen AI Arcade Game Completion": 0,
  ...
  },
  {
    ...
    return (
        <div className='w-full relative px-3'>
            ...
            <div className="sec m-auto my-10 space-y-8 w-1/2 mob:w-full mob:flex mob:flex-col">
                ...
                <div className="info md:flex md:flex-row  flex flex-col mob:justify-center items-center md:space-y-0 space-y-5 mob:p-5 justify-evenly space-x-3 space-x-0">
                    ...
                    <div className="participationdata w-fit mob:w-full h-20 p-5 space-x-5 rounded-lg flex flex-row justify-evenly mob:justify-between items-center bg-blue-50 shadow-lg shadow-blue-300/30 border border-blue-200">
